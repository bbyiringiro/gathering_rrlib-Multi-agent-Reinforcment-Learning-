...
def get_args():
    ...
    parser.add_argument('--num_agents', default=2,
        help='Number of agent policies')
    parser.add_argument('--train_batch_size', default=300,
    ...
    parser.add_argument('--reuse_actors', action='store_true',
        help='Whether to reuse actors(faster)')
    parser.add_argument('--n_apple',type=int, default=60,
        help='Apple respawn stesp')
    parser.add_argument('--n_tag',type=int, default=6,
        help='Number of step agent return after tagged')
    parser.add_argument(
            "--resume",
            action='store_true',
